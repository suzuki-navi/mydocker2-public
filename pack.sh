...
if ! cmp -s $HOME/.mydocker2/credentials.raw.txt $HOME/.mydocker2/credentials.raw.txt.1; then (
    ...
    cat $HOME/.mydocker2/credentials.tar.gz | openssl enc -e -aes256 -pbkdf2 | base64 | tr -d '\n' >| $HOME/.mydocker2/credentials.txt
